...
variable "alert_name_prefix" {
  type        = string
  description = "Optional alert name prefix. Defaults to vm_name when empty."
  default     = ""
}
...
variable "severity" {
  type        = number
  description = "Azure Monitor alert severity. 0 is critical, 4 is verbose."
  default     = 2
}

variable "auto_mitigate" {
  type        = bool
  description = "Automatically resolve metric alerts when condition clears."
  default     = true
}

variable "metric_window_size" {
  type        = string
  description = "Metric alert window size."
  default     = "PT5M"
}

variable "metric_evaluation_frequency" {
  type        = string
  description = "Metric alert evaluation frequency."
  default     = "PT1M"
}
...
variable "memory_used_threshold_percent" {
  type        = number
  description = "Memory used threshold percentage."
  default     = 5
}

variable "disk_consumed_threshold_percent" {
  type        = number
  description = "Disk consumed threshold percentage."
  default     = 5
}
...
variable "log_window_duration" {
  type        = string
  description = "Scheduled query alert window duration."
  default     = "PT15M"
}

variable "log_evaluation_frequency" {
  type        = string
  description = "Scheduled query alert evaluation frequency."
  default     = "PT5M"
}
